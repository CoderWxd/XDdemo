 ...
 -(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        [self.unfoldBtn setImage:[UIImage imageNamed:@"comment_arrow_down"] forState:UIControlStateNormal];
...
-(void)setFrameModel:(UnfoldFrameModel *)frameModel
{
    ...
    if (model.isUnflod) {
        [self.unfoldBtn setImage:[UIImage imageNamed:@"channel_nav_arrow"] forState:UIControlStateNormal];
//        [self.unfoldBtn setTitle:@"显示全部" forState:UIControlStateNormal];
    }else{
        [self.unfoldBtn setImage:[UIImage imageNamed:@"comment_arrow_down"] forState:UIControlStateNormal];
