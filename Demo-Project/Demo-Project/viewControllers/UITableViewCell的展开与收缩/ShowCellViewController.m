...
@interface ShowCellViewController ()<UITableViewDelegate,UITableViewDataSource,UnfoldCellDelegate>
@property (nonatomic,strong)NSMutableArray *dataArray;

@property (nonatomic,weak)UITableView * tableView;
@end

@implementation ShowCellViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"UITableViewCell的展开与收缩";
    [self initLoadData];
    [self initTableView];
}
...
-(void)initLoadData
{
    ...
    NSArray *array  = @[
                        ...
                        @"维基百科（Wikipedia），是一个基于维基技术的多语言百科全书协作计划，这是一部用多种语言编写的网络百科全书。  维基百科一词取自于该网站核心技术“Wiki”以及具有百科全书之意的共同创造出来的新混成词“Wikipedia”，维基百科是由非营利组织维基媒体基金会负责营运，并接受捐赠。",
