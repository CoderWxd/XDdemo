...
@interface CollectionVC ()<UICollectionViewDelegate,UICollectionViewDataSource,TFPubuliuLayout>
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"错乱排布";
...
-(NSMutableArray *)dataSource
{
    if (!_dataSource) {
        ...
        for (int i= 0; i <= 31; i++) {
            UIImage *image = [UIImage imageNamed:[NSString stringWithFormat:@"image/形状图/%d.jpg",i]];
