...
- (void)customInit{
    ...
    UIImage *image = [UIImage imageNamed:@"cottonCandy1"];
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        _self.animationModel.nameEnd = 76;
        _self.animationModel.imageName = @"cottonCandy";
