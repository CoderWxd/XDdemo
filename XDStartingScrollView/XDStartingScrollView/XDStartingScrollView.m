...
@interface XDStartingScrollView() <UIScrollViewDelegate>
/** 页码显示 */
...
@implementation XDStartingScrollView
...
- (void)layoutSubviews
{
    ...
    if (self.direction == HTInfiniteScrollViewDirectionHorizontal) {
...
{
    if ([self.delegate respondsToSelector:@selector(xdStartingScrollView:didSelectItemAtIndex:)]) {

        [self.delegate xdStartingScrollView:self didSelectItemAtIndex:tap.view.tag];
    }
}
